...
{
    m_xmlKeywordFormat.setForeground(Qt::blue);         // Expression Paranthesis
    m_xmlElementFormat.setForeground(Qt::blue);         // Tag Name
    m_xmlAttributeFormat.setForeground(Qt::red);        // Attribute Name
    m_xmlValueFormat.setForeground(Qt::darkMagenta);    // Attribute Value
    m_xmlCommentFormat.setForeground(Qt::darkGray);     // Comments
}
